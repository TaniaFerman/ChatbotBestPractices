...
\subsection*{Conversational content or interaction elements?}
...
\textbf{\textit{Assertions}} are affirmations or messages that the chatbot gives to the user; assertions determine the content of the conversation and allow the listener to increase hir or her knowledge about a certain topic. 
